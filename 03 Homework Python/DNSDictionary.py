...
for i in range(len(providers)):
    DNS_dictionary[providers[i]] = ips[i]
...
for i in range(len(DNS_dictionary)):
...
#print (len(DNS_dictionaries))
print(f'Number of provider: {len(DNS_dictionaries)}')
#print("Number of providers: " + count)
print("--------")
print("--------")
